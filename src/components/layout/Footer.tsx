...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-gray-900 pt-12 pb-8 border-t-4 border-primary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href={SOCIAL_MEDIA.INSTAGRAM} target="_blank" rel="noopener noreferrer" 
                 className="text-accent hover:text-cyan-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {menuItems.map((item) => (
                <li key={item.path}>
                  <Link href={item.path} className="text-gray-600 hover:text-secondary transition-colors">
                    {item.name}
                  </Link>
                </li>
              ))}
